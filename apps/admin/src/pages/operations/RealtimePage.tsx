...
export function RealtimePage({ apiUrl }: { apiUrl: string }) {
  ...
  return (
    <PageCard title="Realtime stream">
      <div className="mb-3 grid grid-cols-1 gap-2 md:grid-cols-4">
        <TextInput value={topics} onChange={(e) => setTopics(e.target.value)} placeholder="topics csv (incident,detection,stream)" />
